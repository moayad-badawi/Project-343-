...
public class removeAdminPage extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					removeAdminPage frame = new removeAdminPage();
	...
	/**
	 * Here we have interesting Jtable that can show the table in database, need to test for futhur error
	 * Need to write more for loading database model into jTable
	 * Need to write more for button response
	 * Return - direct to manageAdminMain
	 * Update - direct to updateAdminPage
	 * Remove - remove the data in database and direct to manageAdminMain
	 */
